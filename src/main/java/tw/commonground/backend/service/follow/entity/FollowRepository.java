...
//            + "values (:#{#id.userId}, :#{#id.objectId}, :#{#id.o
//            bjectType}, :follow, current_timestamp)", nativeQuery = true)
...
//            + "where user_id = :#{#id.userId} and object_id = :#{#id.obj
//            ectId} and object_type = :#{#id.objectType}", nativeQuery = true)
